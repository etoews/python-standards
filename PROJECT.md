...
Opinionated, single-path standards for Python projects. Prescriptive, fork any section if your project genuinely needs otherwise. Machine-level setup (uv install, global config, venv enforcement) lives in **MAC.md**; this file is the next layer up: how to structure and run an individual project.
